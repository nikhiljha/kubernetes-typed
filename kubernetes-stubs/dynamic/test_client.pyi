...
from .resource import ResourceField as ResourceField, ResourceInstance as ResourceInstance
...
class TestDynamicClient(unittest.TestCase):
    ...
    def test_async_namespaced_custom_resources(self) -> None: ...
    ...
    def test_server_side_apply_api(self) -> None: ...

class TestDynamicClientSerialization(unittest.TestCase):
    @classmethod
    def setUpClass(cls) -> None: ...
    def test_dict_type(self) -> None: ...
    def test_resource_instance_type(self) -> None: ...
