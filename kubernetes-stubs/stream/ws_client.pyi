...
from requests.utils import should_bypass_proxies as should_bypass_proxies
...
def websocket_proxycare(connect_opt: Any, configuration: Any, url: Any, headers: Any): ...
