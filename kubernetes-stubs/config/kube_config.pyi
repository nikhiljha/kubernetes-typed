...
class FileOrData:
    def __init__(self, obj: Any, file_key_name: Any, data_key_name: Optional[Any] = ..., file_base_path: str = ..., base64_file_content: bool = ..., temp_file_path: Optional[Any] = ...) -> None: ...
    def as_file(self): ...
    def as_data(self): ...
...
class KubeConfigLoader:
    def __init__(self, config_dict: Any, active_context: Optional[Any] = ..., get_google_credentials: Optional[Any] = ..., config_base_path: str = ..., config_persister: Optional[Any] = ..., temp_file_path: Optional[Any] = ...): ...
...
def load_kube_config(config_file: Optional[Any] = ..., context: Optional[Any] = ..., client_configuration: Optional[Any] = ..., persist_config: bool = ..., temp_file_path: Optional[Any] = ...) -> None: ...
def load_kube_config_from_dict(config_dict: Any, context: Optional[Any] = ..., client_configuration: Optional[Any] = ..., persist_config: bool = ..., temp_file_path: Optional[Any] = ...) -> None: ...
def new_client_from_config(config_file: Optional[Any] = ..., context: Optional[Any] = ..., persist_config: bool = ...): ...
def new_client_from_config_dict(config_dict: Optional[Any] = ..., context: Optional[Any] = ..., persist_config: bool = ..., temp_file_path: Optional[Any] = ...): ...
