...
class V2beta1ContainerResourceMetricStatus:
    ...
    discriminator: Any = ...
    def __init__(self, container: Optional[Any] = ..., current_average_utilization: Optional[Any] = ..., current_average_value: Optional[Any] = ..., name: Optional[Any] = ..., local_vars_configuration: Optional[Any] = ...) -> None: ...
    @property
    def container(self): ...
    @container.setter
