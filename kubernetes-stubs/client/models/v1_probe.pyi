...
class V1Probe:
    ...
    discriminator: Any = ...
    def __init__(self, _exec: Optional[Any] = ..., failure_threshold: Optional[Any] = ..., grpc: Optional[Any] = ..., http_get: Optional[Any] = ..., initial_delay_seconds: Optional[Any] = ..., period_seconds: Optional[Any] = ..., success_threshold: Optional[Any] = ..., tcp_socket: Optional[Any] = ..., termination_grace_period_seconds: Optional[Any] = ..., timeout_seconds: Optional[Any] = ..., local_vars_configuration: Optional[Any] = ...) -> None: ...
    @property
