...
class V1StatefulSetSpec:
    ...
    discriminator: Any = ...
    def __init__(self, min_ready_seconds: Optional[Any] = ..., persistent_volume_claim_retention_policy: Optional[Any] = ..., pod_management_policy: Optional[Any] = ..., replicas: Optional[Any] = ..., revision_history_limit: Optional[Any] = ..., selector: Optional[Any] = ..., service_name: Optional[Any] = ..., template: Optional[Any] = ..., update_strategy: Optional[Any] = ..., volume_claim_templates: Optional[Any] = ..., local_vars_configuration: Optional[Any] = ...) -> None: ...
    @property
    ...
    def persistent_volume_claim_retention_policy(self, persistent_volume_claim_retention_policy: Any) -> None: ...
    @property
