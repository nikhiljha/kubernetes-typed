...
class V1Condition:
    ...
    discriminator: Any = ...
    def __init__(self, last_transition_time: Optional[Any] = ..., message: Optional[Any] = ..., observed_generation: Optional[Any] = ..., reason: Optional[Any] = ..., status: Optional[Any] = ..., type: Optional[Any] = ..., local_vars_configuration: Optional[Any] = ...) -> None: ...
    @property
