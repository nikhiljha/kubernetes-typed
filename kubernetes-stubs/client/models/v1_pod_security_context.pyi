...
class V1PodSecurityContext:
    ...
    discriminator: Any = ...
    def __init__(self, fs_group: Optional[Any] = ..., fs_group_change_policy: Optional[Any] = ..., run_as_group: Optional[Any] = ..., run_as_non_root: Optional[Any] = ..., run_as_user: Optional[Any] = ..., se_linux_options: Optional[Any] = ..., seccomp_profile: Optional[Any] = ..., supplemental_groups: Optional[Any] = ..., sysctls: Optional[Any] = ..., windows_options: Optional[Any] = ..., local_vars_configuration: Optional[Any] = ...) -> None: ...
    @property
    def fs_group(self): ...
    @fs_group.setter
    ...
    def fs_group_change_policy(self, fs_group_change_policy: Any) -> None: ...
    @property
    ...
    def seccomp_profile(self, seccomp_profile: Any) -> None: ...
    @property
