...
class V2beta1ContainerResourceMetricSource:
    ...
    discriminator: Any = ...
    def __init__(self, container: Optional[Any] = ..., name: Optional[Any] = ..., target_average_utilization: Optional[Any] = ..., target_average_value: Optional[Any] = ..., local_vars_configuration: Optional[Any] = ...) -> None: ...
    @property
    def container(self): ...
    @container.setter
