...
class V2beta2HorizontalPodAutoscalerSpec:
    ...
    discriminator: Any = ...
    def __init__(self, behavior: Optional[Any] = ..., max_replicas: Optional[Any] = ..., metrics: Optional[Any] = ..., min_replicas: Optional[Any] = ..., scale_target_ref: Optional[Any] = ..., local_vars_configuration: Optional[Any] = ...) -> None: ...
    @property
    def behavior(self): ...
    @behavior.setter
    def behavior(self, behavior: Any) -> None: ...
    @property
