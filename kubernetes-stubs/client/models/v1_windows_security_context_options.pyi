...
class V1WindowsSecurityContextOptions:
    ...
    discriminator: Any = ...
    def __init__(self, gmsa_credential_spec: Optional[Any] = ..., gmsa_credential_spec_name: Optional[Any] = ..., host_process: Optional[Any] = ..., run_as_user_name: Optional[Any] = ..., local_vars_configuration: Optional[Any] = ...) -> None: ...
    @property
    ...
    @host_process.setter
    def host_process(self, host_process: Any) -> None: ...
    @property
