...
class V1JobSpec:
    ...
    discriminator: Any = ...
    def __init__(self, active_deadline_seconds: Optional[Any] = ..., backoff_limit: Optional[Any] = ..., completion_mode: Optional[Any] = ..., completions: Optional[Any] = ..., manual_selector: Optional[Any] = ..., parallelism: Optional[Any] = ..., selector: Optional[Any] = ..., suspend: Optional[Any] = ..., template: Optional[Any] = ..., ttl_seconds_after_finished: Optional[Any] = ..., local_vars_configuration: Optional[Any] = ...) -> None: ...
    @property
