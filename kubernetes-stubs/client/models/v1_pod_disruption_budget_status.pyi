...
class V1PodDisruptionBudgetStatus:
    ...
    discriminator: Any = ...
    def __init__(self, conditions: Optional[Any] = ..., current_healthy: Optional[Any] = ..., desired_healthy: Optional[Any] = ..., disrupted_pods: Optional[Any] = ..., disruptions_allowed: Optional[Any] = ..., expected_pods: Optional[Any] = ..., observed_generation: Optional[Any] = ..., local_vars_configuration: Optional[Any] = ...) -> None: ...
    @property
    def conditions(self): ...
    @conditions.setter
