...
class V1RuntimeClass:
    ...
    discriminator: Any = ...
    def __init__(self, api_version: Optional[Any] = ..., handler: Optional[Any] = ..., kind: Optional[Any] = ..., metadata: Optional[Any] = ..., overhead: Optional[Any] = ..., scheduling: Optional[Any] = ..., local_vars_configuration: Optional[Any] = ...) -> None: ...
    @property
