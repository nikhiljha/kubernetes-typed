...
class V1CronJobSpec:
    ...
    discriminator: Any = ...
    def __init__(self, concurrency_policy: Optional[Any] = ..., failed_jobs_history_limit: Optional[Any] = ..., job_template: Optional[Any] = ..., schedule: Optional[Any] = ..., starting_deadline_seconds: Optional[Any] = ..., successful_jobs_history_limit: Optional[Any] = ..., suspend: Optional[Any] = ..., time_zone: Optional[Any] = ..., local_vars_configuration: Optional[Any] = ...) -> None: ...
    @property
    ...
    def time_zone(self): ...
    @time_zone.setter
    def time_zone(self, time_zone: Any) -> None: ...
    def to_dict(self): ...
    def to_str(self): ...
