...
class V1PodSpec:
    ...
    discriminator: Any = ...
    def __init__(self, active_deadline_seconds: Optional[Any] = ..., affinity: Optional[Any] = ..., automount_service_account_token: Optional[Any] = ..., containers: Optional[Any] = ..., dns_config: Optional[Any] = ..., dns_policy: Optional[Any] = ..., enable_service_links: Optional[Any] = ..., ephemeral_containers: Optional[Any] = ..., host_aliases: Optional[Any] = ..., host_ipc: Optional[Any] = ..., host_network: Optional[Any] = ..., host_pid: Optional[Any] = ..., host_users: Optional[Any] = ..., hostname: Optional[Any] = ..., image_pull_secrets: Optional[Any] = ..., init_containers: Optional[Any] = ..., node_name: Optional[Any] = ..., node_selector: Optional[Any] = ..., os: Optional[Any] = ..., overhead: Optional[Any] = ..., preemption_policy: Optional[Any] = ..., priority: Optional[Any] = ..., priority_class_name: Optional[Any] = ..., readiness_gates: Optional[Any] = ..., restart_policy: Optional[Any] = ..., runtime_class_name: Optional[Any] = ..., scheduler_name: Optional[Any] = ..., security_context: Optional[Any] = ..., service_account: Optional[Any] = ..., service_account_name: Optional[Any] = ..., set_hostname_as_fqdn: Optional[Any] = ..., share_process_namespace: Optional[Any] = ..., subdomain: Optional[Any] = ..., termination_grace_period_seconds: Optional[Any] = ..., tolerations: Optional[Any] = ..., topology_spread_constraints: Optional[Any] = ..., volumes: Optional[Any] = ..., local_vars_configuration: Optional[Any] = ...) -> None: ...
    @property
    ...
    def host_users(self): ...
    @host_users.setter
    def host_users(self, host_users: Any) -> None: ...
    @property
    def hostname(self): ...
    @hostname.setter
    ...
    def set_hostname_as_fqdn(self, set_hostname_as_fqdn: Any) -> None: ...
    @property
