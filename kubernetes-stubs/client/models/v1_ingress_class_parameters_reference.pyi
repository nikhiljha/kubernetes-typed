...
class V1IngressClassParametersReference:
    ...
    discriminator: Any = ...
    def __init__(self, api_group: Optional[Any] = ..., kind: Optional[Any] = ..., name: Optional[Any] = ..., namespace: Optional[Any] = ..., scope: Optional[Any] = ..., local_vars_configuration: Optional[Any] = ...) -> None: ...
    @property
    def api_group(self): ...
    @api_group.setter
