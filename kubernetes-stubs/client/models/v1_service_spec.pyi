...
class V1ServiceSpec:
    ...
    discriminator: Any = ...
    def __init__(self, allocate_load_balancer_node_ports: Optional[Any] = ..., cluster_ip: Optional[Any] = ..., cluster_i_ps: Optional[Any] = ..., external_i_ps: Optional[Any] = ..., external_name: Optional[Any] = ..., external_traffic_policy: Optional[Any] = ..., health_check_node_port: Optional[Any] = ..., internal_traffic_policy: Optional[Any] = ..., ip_families: Optional[Any] = ..., ip_family_policy: Optional[Any] = ..., load_balancer_class: Optional[Any] = ..., load_balancer_ip: Optional[Any] = ..., load_balancer_source_ranges: Optional[Any] = ..., ports: Optional[Any] = ..., publish_not_ready_addresses: Optional[Any] = ..., selector: Optional[Any] = ..., session_affinity: Optional[Any] = ..., session_affinity_config: Optional[Any] = ..., type: Optional[Any] = ..., local_vars_configuration: Optional[Any] = ...) -> None: ...
    @property
    def allocate_load_balancer_node_ports(self): ...
    @allocate_load_balancer_node_ports.setter
    def allocate_load_balancer_node_ports(self, allocate_load_balancer_node_ports: Any) -> None: ...
    @property
    def cluster_ip(self): ...
    @cluster_ip.setter
    ...
    @cluster_i_ps.setter
    def cluster_i_ps(self, cluster_i_ps: Any) -> None: ...
    @property
    ...
    def internal_traffic_policy(self, internal_traffic_policy: Any) -> None: ...
    @property
    def ip_families(self): ...
    @ip_families.setter
    def ip_families(self, ip_families: Any) -> None: ...
    @property
    def ip_family_policy(self): ...
    @ip_family_policy.setter
    def ip_family_policy(self, ip_family_policy: Any) -> None: ...
    @property
    def load_balancer_class(self): ...
    @load_balancer_class.setter
    def load_balancer_class(self, load_balancer_class: Any) -> None: ...
    @property
