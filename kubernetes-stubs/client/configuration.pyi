...
class Configuration:
    ...
    def __init__(self, host: str = ..., api_key: Optional[Any] = ..., api_key_prefix: Optional[Any] = ..., username: Optional[Any] = ..., password: Optional[Any] = ..., discard_unknown_keys: bool = ...) -> None: ...
    ...
    def get_host_from_settings(self, index: Any, variables: Optional[Any] = ...): ...
